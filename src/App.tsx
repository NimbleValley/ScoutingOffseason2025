...
import { EyeOff, Highlighter, Settings2, X } from "lucide-react";
                    ...
                    return (
                      ...
                      >
                        {numericColumns.map((col) => {
                          ...
                          let className = ` rounded-md px-4 py-1 `;
                          ...
                          return (
                            <td
                              key={col}
                              className="border-t-1 border-b-1 border-gray-500 px-3 py-2 text-center"
                            >
